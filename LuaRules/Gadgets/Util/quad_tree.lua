-- Basic recursive quad tree solution

local Rect = VFS.Include("LuaUI/Widgets/Util/rect.lua")
...
function QuadTree:QueryInCircle(x, y, radius)
    return self:_Query(Rect.new(x - radius, y - radius, radius * 2, radius * 2))
end

function QuadTree:QueryInRect(x, y, width, height)
